  ...
  <div class="all">
    ...
    <el-row :gutter="0" class="conBox">
      <el-col :span="3" class="menuBox">
        <!--左侧菜单-->
        <el-menu default-active="2" class="el-menu-vertical-demo collapsed" @open="handleOpen" @close="handleClose" @select="leftMenu" router>
              <el-submenu index="1">
      ...
      <el-col :span="21" class="mainBox">
        <div class="grid-content ">
          ...
          <el-button type="success" :loading=true >我的加载</el-button>
          <el-button-group>
            <el-button type="primary" icon="edit" size="small">左按钮</el-button>
            <el-button type="primary" icon="edit" size="small">右按钮</el-button>
          </el-button-group>
...
export default {
  router,
  beforeCreate(){
    console.log('看看 this.$route 是不是已经存在啦，关键在于把 router 引入')
